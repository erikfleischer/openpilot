...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    self.mpc.update(sm['modelV2'], v_cruise, personality=sm['selfdriveState'].personality)
  ...
  def publish(self, sm, pm):
    ...
    longitudinalPlan.hasLead = len(sm['modelV2'].leadsV3) > 0 and sm['modelV2'].leadsV3[0].prob > 0.5
